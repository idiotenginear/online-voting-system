...
<body class="hold-transition login-page" style="background-color:778899" >
<div class="login-box" style="background-color:#a69f8b ;color:white ; font-size: 22px; font-family:Times">
  	...
  	<div class="login-box-body"style="background-color:#5F9EA0 ;color:white ; height: 230px; font-size: 22px; font-family:Times  " >
		...
		<form action="../index.php" method="POST">
						 ...
						 <div class="col-xs-12 ">
						 <button type="submit" class="btn btn-primary btn-block btn-curve " style="background-color: #4682B4 ;color:black ; font-size: 12px; font-family:Times" name="login"><i class="fa fa-sign-in"></i>Voter Login</button>
						</div>
						</div>
						</form>
  	</div>
