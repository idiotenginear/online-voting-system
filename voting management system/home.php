...
<div class="wrapper">
	...
	if($voter['status']==0){
	  ...
	  <div class="content-wrapper" style="background-color: #F1E9D2 ">
		...
		<center>
		<div id="Profile" style="background-color:#5F9EA0 ;width:20%;border-style:double;border-color:white">
        <center><img src="images/<?php echo $voter['photo'] ?>" height="100" width="100" ></center>
        <br><br><b>Name :<?php echo $voter['firstname']?></b><br><br>
        <b>Voter ID :<?php echo $voter['voters_id'] ?></b><br><br>
        <b>Address :<?php echo $voter['address'] ?></b><br><br>
					...
					if($voter['status']==1){
						...
						<?php
							...
							while($row = $query->fetch_assoc()){
								...
								$instruct = ($row['max_vote'] > 1) ? 'You can select only one candidate' : 'Select only one candidate';
						...
						<div class="text-center">
							...
							<button type="button" disabled class="btn btn-primary btn-curve" style='background-color: #4682B4 ;color:black ; font-size: 12px; font-family:Times'name="vote"><i class="fa fa-check-square-o"></i> Submit</button>
						</div>
					</form>
					<?php
...
$(function(){
	...
	$('#preview').click(function(e){
		...
		if(form == ''){
			$('.message').html('You must vote first');
			$('#alert').show();
		}
		else{
			$.ajax({
